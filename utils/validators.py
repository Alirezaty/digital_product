...
class PhoneNumberValidator(RegexValidator):
    ...
    massage = 'Phone number must be a VALID 12 digits.'
...
class UsernameValidator(RegexValidator):
    ...
    massage = _('Enter a valid username starting with a-z. '
