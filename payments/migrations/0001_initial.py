# Generated by Django 3.2 on 2023-03-30 15:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.PositiveSmallIntegerField(choices=[(0, 'Void'), (10, 'Paid'), (20, 'Error'), (30, 'User Canceled'), (31, 'Refund')], db_index=True, default=0, verbose_name='status')),
                ...
                ('gateway', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment', to='payments.gateway', verbose_name='packages')),
